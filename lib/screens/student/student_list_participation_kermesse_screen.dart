...
class StudentListParticipationKermesseScreen extends StatefulWidget {
  final int kermesseId;

  const StudentListParticipationKermesseScreen({
    super.key,
    required this.kermesseId,
  });

  @override
  State<StudentListParticipationKermesseScreen> createState() => _StudentListParticipationKermesseScreenState();
}

class _StudentListParticipationKermesseScreenState extends State<StudentListParticipationKermesseScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: InkWell(
        onTap: () async {
          await context.push(
            StudentRoutes.kermesseParticipationDetails,
            extra: {
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Price: ${participation.balance} jeton(s)',
                      style: const TextStyle(
                        fontSize: 16,
                        color: Colors.grey,
                      ),
