...
class StudentDetailsTicketScreen extends StatefulWidget {
  final int ticketId;

  const StudentDetailsTicketScreen({
    super.key,
    required this.ticketId,
  });

  @override
  State<StudentDetailsTicketScreen> createState() => _StudentDetailsTicketScreenState();
}

class _StudentDetailsTicketScreenState extends State<StudentDetailsTicketScreen> {
